document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      } else if (field.getAttribute('minlength') && field.value.trim() !== '' && !VALIDATORS.minlength(field.value, field.getAttribute('minlength'))) {
        isValid = false;
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target.closest('input, textarea, select');
      if (field && contactForm.contains(field) && field.classList.contains('field-invalid')) {
        validateField(field);
      }
    });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0fbd9201-44e9-4714-a4b1-9758058670aa',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0fbd9201-44e9-4714-a4b1-9758058670aa';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9cfb7957-04bb-410f-8c1a-be4c12bfe78c';
